...
<template>
  <div>
    ...
    <h1 class="text-4xl font-black my-8">New Product</h1>
      ...
      <div class="mt-10 p-10 w-full 2xl:w-2/4">
        ...
        >
          <FormKit
            ...
            validation="required"
            :validation-messages="{ required: 'The product name is required' }"
          ...
          <FormKit
            ...
            name="image"
            validation="required"
            :validation-messages="{ required: 'The product image is required' }"
            accept=".jpg"
            @change="onFileChange"
          ...
          <FormKit
            ...
            validation="required"
            :validation-messages="{
              required: 'The available quantity is required',
            }"
            min="1"
