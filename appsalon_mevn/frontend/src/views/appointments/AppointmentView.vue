...
<template>
  ...
  <p class="text-white text-lg">
    A continuaci&oacute;n verifique la informaci&oacute;n y confirme su cita
  </p>
  ...
  <div v-else class="grid gap-5">
    <SelectedService
      ...
      :service="service"
    />
    <p class="text-right text-2xl font-bold text-white">
      Total a Pagar:
    ...
    <div class="lg:flex gap-5 items-start">
      ...
      >
        <button
          ...
          class="block text-blue-500 rounded-lg text-xl font-black p-3 transition-all duration-300 disabled:opacity-10"
          :class="
