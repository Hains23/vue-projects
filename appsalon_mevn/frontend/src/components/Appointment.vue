  ...
  <div class="bg-white p-5 space-y-3 rounded-lg">
    ...
    <div class="flex gap-2 items-center">
      <RouterLink
        ...
        class="bg-slate-600 rounded-lg p-3 text-white text-sm uppercase font-black flex-1 md:flex-none hover:bg-slate-700 transition-all duration-300"
      >
        Editar Cita
      </RouterLink>
      <button
        class="bg-red-600 rounded-lg p-3 text-white text-sm uppercase font-black flex-1 md:flex-none hover:bg-red-700 transition-all duration-300"
      >
        Cancelar Cita
      </button>
    </div>
